...
class BuildTask {
     ...
     */
        gulp.task(`${id}-component-json`, (done) => {
            const {jsonFileList} = this.componentListMap
     ...
     */
        gulp.task(`${id}-component-wxml`, (done) => {
            const {wxmlFileList} = this.componentListMap
     ...
     */
        gulp.task(`${id}-component-wxss`, (done) => {
            const {wxssFileList} = this.componentListMap
     ...
     */
        gulp.task(`${id}-component-js`, (done) => {
            const {jsFileList} = this.componentListMap
